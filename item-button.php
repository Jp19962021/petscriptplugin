    ...
    <div id="ps-rxc-item-card-<?php echo esc_attr($cartItemKey); ?>"
        ...
        <p class="ps-rxc-item-card__status" data-card-status>
            <?php if ($isComplete) : ?>
                ...
                <span data-card-title><?php esc_html_e('Prescription added', 'petscript-rx-checkout'); ?></span>
            <?php else : ?>
        ...
        <button type="button" class="ps-rxc-item-card__btn" data-configure-item="<?php echo esc_attr($cartItemKey); ?>">
            <?php if ($isComplete) : ?>
                ...
                <span data-card-btn-label><?php esc_html_e('Edit Prescription', 'petscript-rx-checkout'); ?></span>
            <?php else : ?>
                ...
                <span data-card-btn-label><?php esc_html_e('Add Prescription', 'petscript-rx-checkout'); ?></span>
            <?php endif; ?>
        </button>
    </div>
</span>
